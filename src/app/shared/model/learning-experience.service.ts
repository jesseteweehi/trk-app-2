...
export class LearningExperienceService {
	...
	learningExperienceList$ : FirebaseListObservable<any>

  	constructor(private af:AngularFireDatabase) { 
	this.learningExperienceList$ = af.list('/learningexperiences');
  	}

	findAllLearningExperiences() {
		return this.learningExperienceList$
	}

	createLearningExperience(form) {
		this.learningExperienceList$.push(form)
	}  
